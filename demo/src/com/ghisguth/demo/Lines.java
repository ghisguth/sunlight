...
public class Lines extends RendererBase {
    ...
    private void renderSun() {
        if (sunProgram != null && baseTexture != null) {
            ...
            Matrix.scaleM(M_matrix, 0, 0.1f, 0.1f, 0.1f);
    ...
    private void renderLines() {
        if (phenixLineProgram != null) {
            ...
            GLES20.glUniform1f(phenixLineProgram.getUniformLocation("uBrightness"), 1.0f);
            GLES20.glUniform3f(phenixLineProgram.getUniformLocation("uColor"), 1.0f, 1.0f, 1.0f);
    ...
    private void loadShaders() {
        ...
        try {
            ...
            vertex = shaderManager.createVertexShader(ResourceHelper.loadRawString(openResource(R.raw.phenix_line_vertex)));
            fragment = shaderManager.createFragmentShader(ResourceHelper.loadRawString(openResource(R.raw.phenix_line_fragment)));
